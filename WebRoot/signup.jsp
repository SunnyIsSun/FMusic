...
<body class="bg-info dker">
      ...
      <section class="m-b-lg">
        ...
        <form action="${pageContext.request.contextPath}/user/register.do" method="post">
          <div class="form-group">
            <input placeholder="Name" class="form-control rounded input-lg text-center no-border" name="username" id="username">
          </div>
          <div class="form-group">
          ...
          <a href="#" class="btn btn-lg btn-info btn-block btn-rounded"><lable id="msg">${msg}~~~</lable></a>
        </form>
      </section>
    </div>
  </section>
  ...
  <footer id="footer">
    <div class="text-center padder clearfix">
      <p>
        <small>版权归FMusic所有<br>&copy; 2017</small>
      </p>
    </div>
  </footer>
  <!-- / footer -->
