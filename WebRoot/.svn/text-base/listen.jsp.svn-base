	...
	<c:forEach items="${list}" var="music" varStatus="status">
		<li class="list-group-item">
			<div class="pull-right m-l">
				<a href="" id="<%=path %>/music/down.do?filename=${music.title }&singer=${music.artist }" class="m-r-sm" onclick="down(this)"><i class="icon-cloud-download"></i>
				</a>
				<a href="<%=path %>/music/addtolist.do?musicId=${music.id}" class="m-r-sm"><i
					class="icon-plus"></i>
				</a>
				<a href="<%=path %>/music/deletelist.do?musicId=${music.id}"><i
					class="icon-close"></i>
				</a>
			</div>
...
<div class="m-t-n-xxs">
  ...
  <footer id="changef" class="footer bg-success dker" style="position:absolute;top: 580px;">
